    ...
    <div className="w-full flex py-4 bg-gray-100 dark:bg-[#111827] dark:border-t dark:border-gray-700 flex-col justify-center items-center ">
      <div className="w-[80%] grid grid-cols-3 xsm:grid-cols-1 gap-y-5 md:grid-cols-3 lg:w-[70%] ">
        ...
        <ul className="flex flex-col text-left text-base font-medium">
          <NavLink to="/" className="py-1 w-fit capitalize font-bold px-3 text-gray-700 cursor-pointer text-base hover:text-blue-600 ">
            Home
          </NavLink>
        ...
        <div className="w-full flex flex-col text-left dark:text-gray-500">
          ...
          <p className="flex w-fit flex-row my-1 ml-2 cursor-pointer hover:text-blue-700 text-sm font-semibold font-sans items-center"><FaGithub className="text-base mr-2"/> : Follow on Github</p>
          <p className="flex w-fit flex-row my-1 ml-2 cursor-pointer hover:text-blue-700 text-sm font-semibold font-sans items-center"><FaInstagram className="text-base mr-2"/> : Follow on Instagram</p>
          <p className="flex w-fit flex-row my-1 ml-2 cursor-pointer hover:text-blue-700 text-sm font-semibold font-sans items-center"><FaLinkedin className="text-base mr-2"/> : Follow on Linkdin</p>
          
          <div className="flex w-fit mt-2 border-2 border-blue-700 overflow-hidden">
            <input type="text" className="outline-none px-1 w-auto bg-white/5" />{" "}
      ...
      <div className="w-full flex flex-col my-5">
        <p className="my-4 text-xl font-bold font-sans dark:text-gray-300">Our Components</p>
