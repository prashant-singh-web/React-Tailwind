...
function TrustedCompany3() {
  
    const [codeShow, setCodeShow] = useState(false);
    return (
      <div className="w-full my-5 flex flex-col ">
        <div className="w-full flex flex-row justify-between">
          <p className="text-lg font-medium font-sans dark:text-gray-200 ">Simple left-aligned</p>
   ...
   import { FaAmazon, FaFacebook, FaGithub, FaGoogle, FaInstagram, FaNode, FaReact, FaTwitter, FaYoutube } from "react-icons/fa";
       ...
       return (
         <div className="w-full my-5 flex flex-col ">
           ...
           <div className="w-full mt-5 rounded-md  bg-white dark:bg-[#111827] border border-gray-400 relative">
             ...
             <div className="w-full flex flex-col justify-between items-center py-20 px-8  dark:text-white xsm:flex-col xsm:py-2 md:flex-col md:py-10 lg:py-14 ">
             <p className="text-xl w-full text-left font-semibold xsm:text-sm md:text-xl">Trusted by the world’s most innovative teams</p>
           <ul className="w-[80%] place-items-center grid h-fit grid-cols-5 xsm:grid-cols-1 md:grid-cols-5 md:w-[90%]  lg:w-[90%] text-gray-700 dark:text-gray-200">
...
export default TrustedCompany3