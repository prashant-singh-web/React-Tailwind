    ...
    <div className="w-full my-5 flex flex-col ">
      ...
      <div className="w-full mt-5 rounded-md  bg-white dark:bg-[#111827] border border-gray-400 relative">
        ...
        <div className="w-full flex flex-col justify-between items-center py-20 px-8  dark:text-white xsm:flex-col xsm:py-5 md:flex-col md:py-10 lg:py-14 ">
          <ul className="w-[80%] gap-1 rounded-md overflow-hidden place-items-center grid h-fit grid-cols-5 xsm:grid-cols-1 sm:grid-cols-2 md:grid-cols-5 md:w-[90%]   text-gray-700 dark:text-gray-200">
            <li className="py-10 bg-gray-100 dark:bg-white/5   w-full">
              <FaGoogle className="text-5xl m-auto xsm:text-3xl md:text-5xl " />
            </li>
            <li className="py-10 bg-gray-100 dark:bg-white/5   w-full">
              <FaGithub className="text-5xl m-auto xsm:text-3xl md:text-5xl " />
            </li>
            <li className="py-10  bg-gray-100 dark:bg-white/5  w-full">
              <FaNode className="text-5xl m-auto xsm:text-3xl md:text-5xl " />
            </li>
            <li className="py-10  bg-gray-100 dark:bg-white/5  w-full">
              <FaReact className="text-5xl m-auto xsm:text-3xl md:text-5xl " />
            </li>
            <li className="py-10  bg-gray-100 dark:bg-white/5  w-full">
              <FaAmazon className="text-5xl m-auto xsm:text-3xl md:text-5xl " />
            </li>
            <li className="py-10 bg-gray-100 dark:bg-white/5   w-full">
              <FaGoogle className="text-5xl m-auto xsm:text-3xl md:text-5xl " />
            </li>
...
export default TrustedCompany5;
